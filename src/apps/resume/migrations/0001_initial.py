    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('other_skills', models.CharField(default='', max_length=200, verbose_name='Other skills')),
                ('hobbies', models.CharField(default='', max_length=200, verbose_name='Hobbies')),
                ('about', models.CharField(default='', max_length=400, verbose_name='About')),
