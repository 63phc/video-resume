...
class QuestionsListView(QuestionContextMixin, ListView):
    ...
    def get_queryset(self, **kwargs):
        ...
        for item in questions:
            if Answer.objects.is_worker_do(question=item, worker_pk=self.kwargs.get('worker_pk')):
...
class QuestionDetailView(QuestionContextMixin, DetailView):
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        answer = Answer.objects.is_worker_do(question=question, worker_pk=self.kwargs.get('worker_pk'))
        if answer:
