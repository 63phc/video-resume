...
urlpatterns = [
    path('job/create/<resume_pk>/<worker_pk>', JobCreateView.as_view(),
         name='dashboard_worker_job_create'),
    path('job/update/<pk>/<resume_pk>/<worker_pk>', JobUpdateView.as_view(),
         name='dashboard_worker_job_update'),
    path('job/delete/<pk>/<resume_pk>/<worker_pk>', JobDeleteView.as_view(),
