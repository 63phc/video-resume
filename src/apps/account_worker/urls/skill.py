...
urlpatterns = [
    path('skill/create/<resume_pk>/<w_pk>', SkillCreateView.as_view(),
         name='dashboard_worker_skill_create'),
    path('skill/update/<pk>/<resume_pk>/<w_pk>', SkillUpdateView.as_view(),
         name='dashboard_worker_skill_update'),
    path('skill/delete/<pk>/<resume_pk>/<w_pk>', SkillDeleteView.as_view(),
